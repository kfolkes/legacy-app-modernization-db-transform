// MIGRATION: Spring Boot 3 / Spring 6 removed WebMvcConfigurerAdapter and HandlerInterceptorAdapter.
// Both were deprecated since Spring 5.0. Replaced with the WebMvcConfigurer interface (default methods)
// and the HandlerInterceptor interface directly. Behavior is unchanged.
...
public class WebMvcConfig implements WebMvcConfigurer {
     ...
     */
    // MIGRATION: HandlerInterceptorAdapter removed in Spring 6; implement HandlerInterceptor directly (its methods now have default impls).
