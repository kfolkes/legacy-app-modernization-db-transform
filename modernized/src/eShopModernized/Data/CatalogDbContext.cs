...
public class CatalogDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // MIGRATION: Provider-specific HiLo configuration.
        // Both SQL Server and Npgsql define UseHiLo() extension methods.
        // We must call the provider-specific version to avoid compile-time ambiguity.
        if (Database.IsSqlServer())
        {
            SqlServerPropertyBuilderExtensions.UseHiLo(
                builder.Entity<CatalogItem>().Property(ci => ci.Id), "catalog_hilo");
            SqlServerPropertyBuilderExtensions.UseHiLo(
                builder.Entity<CatalogBrand>().Property(cb => cb.Id), "catalog_brand_hilo");
            SqlServerPropertyBuilderExtensions.UseHiLo(
                builder.Entity<CatalogType>().Property(ct => ct.Id), "catalog_type_hilo");
        }
        else
        {
...
public class CatalogItemConfiguration : IEntityTypeConfiguration<CatalogItem>
{
    public void Configure(EntityTypeBuilder<CatalogItem> builder)
    {
        ...
        // NOTE: UseHiLo is configured in OnModelCreating for dual-provider support
